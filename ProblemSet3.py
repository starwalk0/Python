...
def problem3_3(month, day, year):
    ...
    print(months[month-1]," ", day, ", ", year, sep = '')
...
def problem3_4(mon, day, year):
    ...
    months_d = {"January":1, "February":2, "March":3, "April":4, "May":5,
                "June":6, "July":7, "August":8, "September":9, "October":10,
                "November":11, "December":12}
    print(months_d[mon],day, year, sep="/")
...
def problem3_7(csv_pricefile, flower):
    ...
    pricefile = open(csv_pricefile)
    d_flowers = {}
    
    for row in csv.reader(pricefile):
        d_flowers[row[0]] = row[1]
               
    print(d_flowers[flower])
    pricefile.close()
#%%